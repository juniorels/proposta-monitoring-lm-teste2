            ...
            <div className="relative w-full max-w-xs">
              ...
              <div className="absolute -left-2 lg:-left-4 top-1/2 -translate-y-1/2">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[#F44336] text-[7px] lg:text-[8px] font-medium mt-0.5 -rotate-90 origin-center whitespace-nowrap">INSUSTENTÁVEL</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative w-full max-w-xs">
              ...
              <div className="absolute -right-2 lg:-right-4 top-1/2 -translate-y-1/2">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[#00A650] text-[7px] lg:text-[8px] font-medium mt-0.5 rotate-90 origin-center whitespace-nowrap">ESCALÁVEL</p>
                </div>
              </div>
            </div>
          </div>
